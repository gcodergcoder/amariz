...
import Expand from "../../utlis/Icons/Expand";
...
const Index = () => {
    ...
    const [modalQoutes, setModalQoutes] = useState(false);
    const [dataQoutes, setDataQoutes] = useState({});

    return (
        <>
            {modalQoutes ? <QuoteForm setModal={setModalQoutes} cleanData={setDataQoutes} refetch={refetch} /> : <></>}
            <div className="flex p-2 text-sm text-gray-800">
                ...
                <div className="flex-col justify-start lg:w-10/12 lg:px-4">
                    ...
                    <div className="flex justify-between border border-gray-300 rounded-lg my-4 py-4">
                        ...
                        <button
                            onClick={() => {
                                setModalQoutes(!modalQoutes);
                            }}
                            className="w-2/12 mx-1 bg-amariz_6 text-white h-10 rounded-md"
                        >
                            Nuevo
                        </button>
                    </div>
        ...
        <tr className={css_tr}>
            ...
            <td className={`${css_td} lg:w-5/24`}>
                ...
                <Link
                    ...
                    className={`${css_span_2} justify-end`}
                >
                    <Expand />
                </Link>
            </td>
