...
const modelsInfo = {
    ...
    Qoutes: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId"],
...
const outputsInfo = {
    ...
    QoutesGroupBy: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId", "_count", "_min", "_max"],
    ...
    QoutesCountAggregate: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId", "_all"],
    QoutesMinAggregate: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId"],
    QoutesMaxAggregate: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId"],
...
const inputsInfo = {
    ...
    QoutesWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId", "provider", "agentProvider", "qoutesDetails"],
    QoutesOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId", "provider", "agentProvider", "qoutesDetails"],
    QoutesWhereUniqueInput: ["id", "AND", "OR", "NOT", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId", "provider", "agentProvider", "qoutesDetails"],
    QoutesOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId", "_count", "_max", "_min"],
    QoutesScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId"],
    ...
    QoutesCreateInput: ["id", "createdAt", "updatedAt", "expireAt", "provider", "agentProvider", "qoutesDetails"],
    QoutesUpdateInput: ["id", "createdAt", "updatedAt", "expireAt", "provider", "agentProvider", "qoutesDetails"],
    QoutesCreateManyInput: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId"],
    QoutesUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "expireAt"],
    ...
    QoutesCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId"],
    QoutesMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId"],
    QoutesMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId"],
    ...
    QoutesCreateWithoutProviderInput: ["id", "createdAt", "updatedAt", "expireAt", "agentProvider", "qoutesDetails"],
    ...
    QoutesScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "expireAt", "providerId", "agentProviderId"],
    ...
    QoutesCreateWithoutAgentProviderInput: ["id", "createdAt", "updatedAt", "expireAt", "provider", "qoutesDetails"],
    ...
    QoutesCreateWithoutQoutesDetailsInput: ["id", "createdAt", "updatedAt", "expireAt", "provider", "agentProvider"],
    ...
    QoutesUpdateWithoutQoutesDetailsInput: ["id", "createdAt", "updatedAt", "expireAt", "provider", "agentProvider"],
    AgentProviderCreateManyProviderInput: ["id", "createdAt", "updatedAt", "name", "surName", "email", "phone"],
    QoutesCreateManyProviderInput: ["id", "createdAt", "updatedAt", "expireAt", "agentProviderId"],
    AgentProviderUpdateWithoutProviderInput: ["id", "createdAt", "updatedAt", "name", "surName", "email", "phone", "qoutes"],
    QoutesUpdateWithoutProviderInput: ["id", "createdAt", "updatedAt", "expireAt", "agentProvider", "qoutesDetails"],
    QoutesCreateManyAgentProviderInput: ["id", "createdAt", "updatedAt", "expireAt", "providerId"],
    QoutesUpdateWithoutAgentProviderInput: ["id", "createdAt", "updatedAt", "expireAt", "provider", "qoutesDetails"],
