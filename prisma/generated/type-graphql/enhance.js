...
const inputsInfo = {
    ProvidersWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "nit", "address", "agentProvider"],
    ProvidersOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "name", "nit", "address", "agentProvider"],
    ProvidersWhereUniqueInput: ["id", "AND", "OR", "NOT", "createdAt", "updatedAt", "name", "nit", "address", "agentProvider"],
    ...
    ProvidersCreateInput: ["id", "createdAt", "updatedAt", "name", "nit", "address", "agentProvider"],
    ProvidersUpdateInput: ["id", "createdAt", "updatedAt", "name", "nit", "address", "agentProvider"],
    ...
    AgentProviderCreateInput: ["id", "createdAt", "updatedAt", "name", "surName", "email", "phone", "provider"],
    AgentProviderUpdateInput: ["id", "createdAt", "updatedAt", "name", "surName", "email", "phone", "provider"],
    ...
    AgentProviderCreateWithoutProviderInput: ["id", "createdAt", "updatedAt", "name", "surName", "email", "phone"],
    ...
    ProvidersCreateWithoutAgentProviderInput: ["id", "createdAt", "updatedAt", "name", "nit", "address"],
    ...
    ProvidersUpdateWithoutAgentProviderInput: ["id", "createdAt", "updatedAt", "name", "nit", "address"],
    AgentProviderCreateManyProviderInput: ["id", "createdAt", "updatedAt", "name", "surName", "email", "phone"],
    AgentProviderUpdateWithoutProviderInput: ["id", "createdAt", "updatedAt", "name", "surName", "email", "phone"]
};
